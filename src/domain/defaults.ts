...
export function createDefaultWorkspace(now = new Date().toISOString()): {
  ...
  return {
    ...
    modelAssets: [
      ...
      {
        id: "model_google_tts_ne",
        runtimeId: "runtime_google_tts",
        name: "Google Gemini TTS Nepali",
        kind: "tts",
        family: "google_gemini_tts",
        version: "gemini-3.1-flash-tts-preview",
        pathOrTag: "google:texttospeech:v1:gemini-3.1-flash-tts-preview:ne-NP",
    ...
    voices: [
      ...
      },
      {
        ...
        name: "Google Gemini Nepali",
        runtimeId: "runtime_google_tts",
        type: "builtin",
        language: "ne-NP",
        tags: ["cloud", "google", "nepali"],
        previewUrl: "",
        privacy: "workspace",
        cloneStatus: "not_clone",
        consentId: null,
